(function() {
    ...
    function generar_proceso() {
        ...
        repintar_procesos();
        if(proceso_creado.rafaga < colaListos[procesoActual].rafaga){
            var fila = d3.select('#proceso-' + procesoActual);
            bloquear_proceso(procesoActual, fila);
            reanudar_proceso();
        }
    }
