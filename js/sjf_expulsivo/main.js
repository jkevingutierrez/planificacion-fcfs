(function() {
    ...
    function generar_proceso() {
        ...
        var proceso_creado = crear_proceso(nombre, rafaga);
        var pos_proceso_creado = colaListos.length - 1;

        var proceso_actual = colaListos[procesoActual];
        console.log("------------------------------------------");
        console.log("creado: "+proceso_creado.prioridad);
        console.log("actial: "+proceso_actual.prioridad);
        console.log("------------------------------------------");
        if (proceso_creado.prioridad < proceso_actual.prioridad) {
            console.log("entro");
            proceso_actual.rafaga = tiempo_restante;
            console.log("1");
            proceso_actual.nombre = proceso_actual.nombre + " (suspendido)";
            console.log("2");
            actualizar_columna_tabla_listos(procesoActual, proceso_actual);
            console.log("3");
            console.log("3");
            colaListos.push(proceso_actual);
            console.log("4");
            procesoActual = pos_proceso_creado;
            console.log("5");
            actualizar_columna_tabla_listos(procesoActual, proceso_creado);
            console.log("6");
            repintar_procesos();
        };
    ...
    Main.prototype.ejecutar = function() {
        ...
        window.setInterval(function() {
            ...
            colaListos[procesoActual].rafaga--;
